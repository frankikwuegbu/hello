...
export default function Header(props) {
  return (
                      ...
                      <NavLink
                        ...
                        to={item.href}
                         className={({isActive}) => {
                          ...
                          (isActive ? 'bg-gray-700 text-white no-underline' : 'text-gray-300 hover:text-white hover:bg-gray-700 no-underline')
                         }
                      }
                      >
                        {item.name}
    ...
    <div className='bg-gray-500 min-h-screen p-2' >{props.children}</div>
    </>
  )
}

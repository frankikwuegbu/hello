    ...
    <>
        ...
        >
            ...
            <Modal.Footer>
                ...
                <button form='editmodal' className="bg-purple-600 hover:bg-purple-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                    Confirm
                </button>
            </Modal.Footer>
      </Modal>
